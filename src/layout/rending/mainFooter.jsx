...
export default function MainFooter(){
    return (<>
        <footer>
            ...
            <p className="flex justify-center mt-20 text-gray-400 font-light"> Copyright © 2024, Made with ️ by <span>&nbsp; Prantry Technologies &nbsp;</span> Version 0.1.0-SNAPSHOT</p>
