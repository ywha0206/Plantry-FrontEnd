...
export default function Document() {
  ...
  return (
    <div id='document-container'>
      <aside className='document-aside overflow-scroll flex flex-col scrollbar-none'>
      ...
      <section className='document-main'>
        ...
        <section className='flex  justify-between mt-8 mb-6'>
          ...
          <div className='flex gap-2'>
            <button className='bg-purple white w-20 h-8 rounded-md text-xs'>폴더생성</button>
            <button className='bg-purple white w-20 h-8 rounded-md text-xs'>파일업로드</button>
          </div>
        </section>
