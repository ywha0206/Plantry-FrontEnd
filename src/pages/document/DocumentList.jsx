...
export default function DocumentList() {
    ...
    useEffect(() => {
        const fetchFolderContents = async (folderId) => {
            try {
                const response = await axiosInstance.get(`/api/drive/folder-contents?folderId=${folderId}`);
    ...
    return (
       <DocumentLayout>
                <section className='flex gap-4 items-center'>
                    <p className='text-2xl ml-4 mt-4'>{text}</p><img className='w-6 h-6 mt-3' src='/images/document-pen.png'></img>
                </section>
