...
export default function AdminUser() {
  ...
  return (
    <div id='admin-user-container'>
      <aside className='admin-user-aside overflow-scroll flex flex-col'>
        ...
        <section className='flex justify-center mb-8 w-26'>
            <select className='outline-none border rounded-l-md opacity-80 h-10 w-24 text-center text-sm'>
                <option>참여자</option>
                <option>부장</option>
                <option>담당업무</option>
            </select>
      ...
      <section className='admin-user-main'>
        ...
        <section className='flex items-center gap-4 mb-32'>
            <div className='ml-4 text-2xl'>인사 관리</div>
