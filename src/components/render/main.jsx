          ...
          <section className="text-center py-20 bg-white shadow-lg rounded-md" data-aos="fade-up">
            ...
            <div className="mt-10" data-aos="fade-up" data-aos-delay="400">
              <img
                ...
                alt="Plantry 로고"
                className="w-32 mt-[40px] mx-auto rounded-full hover:rotate-6 transition-transform duration-700 hover:scale-125"
              />
              <h3 className="mt-5 text-gray-700 font-semibold text-lg">
        ...
        >
          자세히 보기
            ...
            <div className="flex justify-center mt-16">
              <button
                className="px-8 py-4 bg-indigo-400 text-white font-bold rounded-full shadow-lg hover:bg-indigo-500 transition-transform duration-300 transform "
