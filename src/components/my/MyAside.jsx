      ...
      <div>
        ...
        <ul className='mt-[20px]'>
          <Link to='/my'>
            ...
            >
              <span className={`${
                menuActive === 'my' ? 'text-indigo-600 bg-indigo-500 font-bold' : ''
              }`}>나의 프로필</span>
          ...
          <Link to='/my/approval'>
            ...
            >
              <span className={`${
                menuActive === 'approval' ? 'text-indigo-600 bg-indigo-500 font-bold' : ''
              }`}>나의 결재현황</span>
              <img className='my-menu-allow' src='/images/arrowRight.png' alt='allow' />
            </li>
          </Link>
          <Link to='/my/attendance'>
            ...
            >
              <span className={`${
                menuActive === 'attendance' ? 'text-indigo-600 bg-indigo-500 font-bold' : ''
              }`}>나의 출퇴근현황</span>
              <img className='my-menu-allow' src='/images/arrowRight.png' alt='allow' />
            </li>
          </Link>
          <Link to='/my/payment'>
            ...
            >
              <span className={`${
                menuActive === 'payment' ? 'text-indigo-600 bg-indigo-500 font-bold' : ''
              }`}>나의 결제정보</span>
              <img className='my-menu-allow' src='/images/arrowRight.png' alt='allow' />
            </li>
          </Link>
